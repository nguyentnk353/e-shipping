...
function UserUpdateAction() {
  ...
  const handleOk = () => {
    ...
    updateBill(bill)
      .then(alert('Sửa đổi đơn thành công'))
      .catch((err) => {
        if (err.response) {
  ...
  const blurChangeDestinationDepartmentId = (value, data) => {
    if (
      bill.DestinationDepartmentId === 0 &&
      (typeof value === 'object' || value === 0)
    ) {
      setErrors({
        ...errors,
                  ...
                  <div className='input-1-4'>
                    <div className='input-every-2-8'>
                      ...
                      >
                        <input
                          ...
                          onChange={(event) =>
                            handleChange(event, 'NameSender')
                          }
                          onBlur={(event) =>
                            validade(event, 'NameSender', 'họ và tên người gửi')
                          }
                        />
                        <span className='form-message-page-create-new-order'>
                          {errors.NameSender}
                        </span>
                      </Form.Item>
                    </div>
                    <div className='input-every-2-8'>
                      ...
                      >
                        <input
                          type='text'
                          className='input-every 3'
                          placeholder='Số điện thoại'
                          value={bill.PhoneSender}
                          onChange={(event) =>
                            handleChange(event, 'PhoneSender')
                          }
                          onBlur={(event) =>
                            validade(event, 'PhoneSender', 'số điện thoại')
                          }
                        />
                        <span className='form-message-page-create-new-order'>
                          {errors.PhoneSender}
                    ...
                    <div className='input-every-2-8'>
                      ...
                      >
                        <input
                          ...
                          onChange={(event) =>
                            handleChange(event, 'NameReceive')
                          }
                          onBlur={(event) =>
                            validade(
                              event,
                    ...
                    <div className='input-every-2-8'>
                      ...
                      >
                        <input
                          ...
                          onChange={(event) =>
                            handleChange(event, 'PhoneReceive')
                          }
                          onBlur={(event) =>
                            validade(event, 'PhoneReceive', 'số điện thoại')
                          }
                        />
                        <span className='form-message-page-create-new-order'>
                          {errors.PhoneReceive}
          ...
          <div className='frame-merchandise-service'>
            <div>
              <div className='frame service'>
                <div className='content service'>
                  ...
                  <div style={{ fontWeight: '700' }}>
                    ...
                    <div style={{ fontWeight: '480', margin: '10px 0' }}>
                      ...
                      ></Select>
                      <span className='form-message-page-create-new-order-service'>
                        {errors.StartDepartmentId}
                      </span>
                    </div>
                  </div>
                    ...
                    >
                      ...
                      >
                        <input
                          ...
                          onBlur={(event) =>
                            validade(event, 'Weight', 'khối lượng > 0')
                          }
                        />
                        <span className='form-message-page-create-new-order-service'>
                          {errors.Weight}
                ...
                <button
                  className='btn-page-create-new-order'
                ...
                >
                  <Row>
                    <Col span={12}>
                      <p>
                        <b>Người gửi:</b> {bill.NameSender}
                      </p>
                    </Col>
                    <Col span={12}>
                      <p>
                        <b>Số điện thoại:</b> {bill.PhoneSender}
                      </p>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={12}>
                      <p>
                        <b>Người nhận:</b> {bill.NameReceive}
                      </p>
                    </Col>
                    <Col span={12}>
                      <p>
                        <b>Số điện thoại:</b> {bill.PhoneReceive}
                      </p>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={12}>
                      <p>
                        <b>Loại hàng hóa:</b> {bill.CategoryName}
                      </p>
                    </Col>
                    <Col span={12}>
                      <p>
                        <b>Khối lượng:</b> {bill.Weight} Kg
                      </p>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={12}>
                      <p>
                        <b>Bưu cục gửi:</b> {bill.StartDepartmentName}
                      </p>
                    </Col>
                    <Col span={12}>
                      <p>
                        <b>Bưu cục nhận:</b> {bill.DestinationDepartmentName}
                      </p>
                    </Col>
                  </Row>
                  <Row>
                    <Col span={24}>
                      <p hidden={bill.Address === ''}>
                        <b>Địa chỉ nhận: </b> {bill.Address}
                      </p>
                    </Col>
                  </Row>
                  <Row>
